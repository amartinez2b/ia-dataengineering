# Ejercicio 03 - Refactorización y debugging con Codex

## Objetivo

Practicar un flujo real de desarrollo asistido con Codex sobre el repositorio `multihope`: importar el proyecto a GitHub personal, clonarlo localmente, analizarlo, pedir mejoras y usar el agente para debugging.
...
## Parte C - Abrir Codex en el proyecto local
...
Ahora todo el ejercicio se realizará dentro de este repositorio local usando Codex.

## Parte D - Pedir análisis inicial

Abre Codex dentro del proyecto y pide algo como:
...
Si el estudiante ya tiene cambios locales, también puede pedir una revisión breve con:
...
6. una reflexión breve sobre qué hizo bien Codex y qué tuvo que validar manualmente

## Conclusión esperada

El estudiante debería observar que Codex puede acelerar bastante el análisis, la refactorización y el debugging de un proyecto real como `multihope`, pero que la validación técnica y la decisión final siguen siendo responsabilidad del humano.
